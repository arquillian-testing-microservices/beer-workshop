...
And then modify `jpa-beer-service-2/src/test/java/org/beer/workshop/org.beer.workshop.BeerEndpointTest.java` to look like:

[source, java]
.jpa-beer-service-2/src/test/java/org/beer/workshop/org.beer.workshop.org.beer.workshop.BeerEndpointTest.java
----
...
@RunWith(Arquillian.class)
public class org.beer.workshop.org.beer.workshop.BeerEndpointTest {
...
[source, java]
.org.beer.workshop.BeerEndpointTest.java
----
@RunWith(Arquillian.class)
...
Finally open `org.beer.workshop.org.beer.workshop.BeerEndpointTest`, removes `@Deployment` method and enrich test with Docker data.
...
public class BeerEndpointTest {
    ...
    @After
    public void cleanCollection() {
        noSqlPopulator.forServer(dockerHost, 27017)
                .withStorage("test")
                .clean();
    }
